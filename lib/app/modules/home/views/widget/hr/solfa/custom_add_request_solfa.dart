...
class CustomSolfaAddRequest extends GetView<HomeController> {
  @override
                  ...
                  SizedBox(
                      ...
                      child: InkWell(
                          onTap: () {
                            ...
                            controller.expandedLoanRequest.value = true;
                          },
                          child: CircleAvatar(
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            Text('${controller.startMonthsLoans.value
                                .month}/${controller.startMonthsLoans.value
                                .year}',
                                style: TextStyle(fontWeight: FontWeight.bold),
                                textAlign: TextAlign.center),
                          ),
                            ...
                            InkWell(
                              onTap: () async {
                                final pickedDate = await showMonthPicker(
                                  ...
                                  firstDate: DateTime(1900),
                                  lastDate: DateTime(2100),
                                  initialDate: controller.startMonthsLoans
                                      .value,
                                  monthStylePredicate: (month) {
                                    if (month ==
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  Text('${controller.startMonthsLoans.value
                                      .month}/${controller.startMonthsLoans
                                      .value.year}',
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold),
                                      textAlign: TextAlign.center),
              ...
              children: [
                ...
                CustomTextFormField(
                  ...
                  onChanged: (v) {
                    if (controller.loanValue.text.isNotEmpty &&
                        controller.nofMonths.text.isNotEmpty) {
                      var res = double.parse(controller.loanValue.text) ~/
