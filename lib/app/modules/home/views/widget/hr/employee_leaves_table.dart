...
import '../../../model/hr/get_employee_leaves/EmployeesLeaves.dart';

class EmployeeLeavesTable extends GetView {
  final List<EmployeesLeaves> selectedItems;

  EmployeeLeavesTable({required this.selectedItems});
    ...
    return Row(
      children: <Widget>[
        Container(
          ...
          padding: const EdgeInsets.fromLTRB(5, 0, 0, 0),
          alignment: Alignment.center,
          child: controller.allEmployeesLeaves.value.data?[0]
              .employeesLeaves?[index].code ==
              null
              ? const Text('')
              : Text(
        ...
        Container(
          ...
          child:
          controller.allEmployeesLeaves.value.data?[0]
              .employeesLeaves?[index].leaveDateGregi ==
              null
              ? const Text('')
              : Get
              .find<LanguageController>()
              ...
              Get
                  ...
                  .isUrdo ||
                          Get.find<LanguageController>().isHindi
                      ? Text(
            '${intl.DateFormat('yyyy-MM-dd').format(DateTime.parse(controller.allEmployeesLeaves.value.data?[0].employeesLeaves?[index].leaveDateGregi ?? ''))}',
                    )
                      : Text(
