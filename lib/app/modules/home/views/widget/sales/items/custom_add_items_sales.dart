...
class CustomAddItemsSales extends GetView<HomeController> {
  @override
                  ...
                  SizedBox(
                      ...
                      child: InkWell(
                          onTap: () {
                            ...
                            controller.expandedItemsRequest.value = true;
                          },
                          child: CircleAvatar(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomTextFormField(
                        controller: controller.unitItemsSales,
                        type: TextInputType.name,
                        color: Colors.white,
                        radius: 14,
                        onChanged: (v) {},
                      ...
                      CustomTextFormField(
                        controller: controller.priceItemsSales,
                        type: TextInputType.number,
                        color: Colors.white,
                        radius: 14,
                        onChanged: (v) {},
                      ...
                      CustomTextFormField(
                        controller: controller.barcodeItemsSales,
                        type: TextInputType.text,
                        color: Colors.white,
                        radius: 14,
                        onChanged: (v) {},
