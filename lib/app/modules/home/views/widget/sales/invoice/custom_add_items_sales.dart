...
class CustomAddItemsToInvoice extends GetView<HomeController> {
  @override
              ...
              child: Row(
                children: [
                  SizedBox(
                      ...
                      child: InkWell(
                          onTap: () async {
                            // if (controller.editInvoiceSales.value == true) {
                  ...
                  SizedBox(
                      ...
                      child: InkWell(
                          onTap: () {
                            controller.clearItemsAddedToInvoice();
                            controller.addInvoiceSales.value = true;
                            controller.editInvoiceSales.value = false;
                            controller.addItemsInvoiceSales.value = false;
                            controller.salesInvoice.value = true;
                            controller.expandedInvoiceRequest.value = true;
                          },
                          child: CircleAvatar(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      ListLoanTypeTextField(
                        action: () {
                          controller.customerNameInvoice.clear();
                        },
                        suggetionCallBack: (pattern) async {
                        ...
                        controller: controller.customerNameInvoice,
                      ),
                      const SizedBox(
                        height: 10,
                      ),
                      ...
                      CustomTextFormField(
                        controller: controller.priceItemInvoice,
                        type: TextInputType.number,
                        color: Colors.white,
                        radius: 14,
                        onChanged: (v) {},
                      ...
                      CustomTextFormField(
                        controller: controller.quantityItemInvoice,
                        type: TextInputType.number,
                        color: Colors.white,
                        radius: 14,
                        onChanged: (v) {},
