...
class CustomAddNewDiscountSales extends GetView<HomeController> {
  @override
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomTextFormField(
                        controller: controller.codeaDiscountSales,
                        type: TextInputType.text,
                        color: Colors.white,
                        radius: 14,
                        textAlign: TextAlign.center,
                      ...
                      CustomTextFormField(
                        controller: controller.enNameDiscountSales,
                      ...
                      CustomTextFormField(
                        controller: controller.arNameDiscountSales,
                        type: TextInputType.name,
                        color: Colors.white,
                        radius: 14,
                        onChanged: (v) {},
                      ...
                      CustomTextFormField(
                        controller: controller.typesDiscountSales,
                        type: TextInputType.name,
                        color: Colors.white,
                        radius: 14,
                        onChanged: (v) {},
                      ...
                      CustomTextFormField(
                        controller: controller.valueDiscountSales,
                        type: TextInputType.number,
                        color: Colors.white,
                        radius: 14,
                        onChanged: (v) {},
                      ...
                      Text(
                        LocaleKeys.maxValue.tr,
                        style: const TextStyle(
                            fontWeight: FontWeight.bold, fontSize: 14),
                        textAlign: TextAlign.start,
                      ),
                      CustomTextFormField(
                        controller: controller.maxValueDiscountSales,
                        type: TextInputType.number,
                        color: Colors.white,
                        radius: 14,
                        onChanged: (v) {},
